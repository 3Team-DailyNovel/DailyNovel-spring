...
<body class="container-1">
            ...
            <header class="header lc-center">
                <div class="box-large h1  font-weight-700">돌아보기</div>
            </header>

            <nav class="main pd-a lc-space-between-alignment">
                    <div class="analysis-main-btn1 h1 "><a class= "font-h a-btn  lc-center font-weight-700" href="/analysis/feeling">기분</a></div>
                    <div class="analysis-main-btn1 h1 "><a class= "font-h a-btn  lc-center font-weight-700" href="/analysis/honesty">솔직함</a></div>
                    <div class="analysis-main-btn1 h1 "><a class= "font-h a-btn  lc-center font-weight-700" href="/analysis/how">How</a></div>
                    <div class="analysis-main-btn1 h1 "><a class= "font-h a-btn  lc-center font-weight-700" href="/analysis/feeling">내가 좋아한 일기</a></div>
            </nav>
