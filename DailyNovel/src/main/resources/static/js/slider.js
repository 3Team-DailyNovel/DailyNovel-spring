//이거 추가했다간 오류 발생할 지도 모 름 
//(slide.js class화 시킴 귀찮아서 이벤트는 모두 생성자에 때려박음)


class slide{
   
    constructor(slide, prevBtn,nextBtn,slideItems,pagination,paginationItems){
        ...
        this.slideItems = document.querySelectorAll(slideItems);
    ...
    nextMove() {
        ...
        if (this.currSlide <= this.maxSlide) {
            ...
            const offset = this.slideWidth * (this.currSlide - 1);
